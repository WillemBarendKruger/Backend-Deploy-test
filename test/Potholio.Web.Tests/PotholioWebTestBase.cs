...
{
    public abstract class PotholioWebTestBase : AbpAspNetCoreIntegratedTestBase<Startup>
    {
        protected static readonly Lazy<string> ContentRootFolder;

        static PotholioWebTestBase()
        {
        ...
        protected override IWebHostBuilder CreateWebHostBuilder()
        {
            return base
                ...
                .UseSetting(WebHostDefaults.ApplicationKey, typeof(PotholioWebMvcModule).Assembly.FullName);
        }
        ...
        {
            using (var context = IocManager.Resolve<PotholioDbContext>())
            {
                action(context);
                context.SaveChanges();
            }
        ...
        protected async Task UsingDbContextAsync(Func<PotholioDbContext, Task> action)
        {
            using (var context = IocManager.Resolve<PotholioDbContext>())
            {
        ...
        protected async Task<T> UsingDbContextAsync<T>(Func<PotholioDbContext, Task<T>> func)
        {
            T result;
